...
|---|---|---|  
| \*\*Frontend\*\* | Next.js 14 \+ React \+ TypeScript | Renderingat del costat del servidor (SSR), rutes App Router |  
...
|---|---|---|---|  
| \`restaurant\_tpv\_db\` | \`postgres:15-alpine\` | 5432 | Base de dades PostgreSQL |  
| \`restaurant\_tpv\_pgadmin\` | \`dpage/pgadmin4\` | 5050 | Interfície web d'administració de BD |
...
│   ├── config\_db.js          \#   Configuració de connexió a BD  
...
\# Canvia "5432:5432" per "5433:5432" i actualitza DB\_PORT al .env  
\`\`\`
...
NEXT\_PUBLIC\_WS\_URL=http://localhost:3000  
\`\`\`
...
docker volume rm bistrostreet\_postgres\_data
